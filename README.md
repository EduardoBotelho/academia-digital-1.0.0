...
<p>Ao final deste projeto, o Dev irá conhecer os principais conceitos de mapeamento objeto relacional (ORM) usando o <strong>Spring Data JPA</strong>. Para isso, uma <strong>API RESTful</strong> será desenvolvida com ênfase na modelagem de suas entidades, no domínio de uma avaliacaoMedica de ginástica.</p>
...
<h2>🔗 Links Úteis</h2>
<ul>
    <li><a href="https://start.spring.io/#!type=maven-project&language=java&platformVersion=2.6.1&packaging=jar&jvmVersion=11&groupId=me.dio.avaliacaoMedica&artifactId=avaliacaoMedica-digital&name=avaliacaoMedica-digital&description=Tutorial%20API%20RESTful%20modelando%20sistema%20de%20avaliacaoMedica%20de%20gin%C3%A1stica&packageName=me.dio.avaliacaoMedica.digital&dependencies=web,data-jpa,postgresql,validation,lombok">Spring Initializr</a></li>
